function GitCalendarInit(git_gitapiurl, git_color, git_user) {
  // 由于 git_gitapiurl 为https://python-github-calendar-api-lake-six.vercel.app/api?Alleyway-boop
  // 我们需要将 修改参数为 https://python-github-calendar-api-lake-six.vercel.app/api?user=Alleyway-boop 这样的形式 保留?前面的部分，后面的部分移除
  git_gitapiurl = git_gitapiurl.split('?')[0] + '?user=' + git_user
